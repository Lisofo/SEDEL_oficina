...
class _MapaPageDesktopState extends State<MapaPageDesktop> with SingleTickerProviderStateMixin {
                ...
                children: [
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final initialHeight = MediaQuery.of(context).size.height - 141; // Puedes ajustar esto según tus necesidades
