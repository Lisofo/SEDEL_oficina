...
import 'package:sedel_oficina_maqueta/pages/menusRevisiones/ptosInspeccion/revision_ptos_inspeccion_page.dart';
...
class _RevisionOrdenPageState extends State<RevisionOrdenPage> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          ...
          if (menu == 'Ptos de Inspeccion') RevisionPtosInspeccionMenu(
