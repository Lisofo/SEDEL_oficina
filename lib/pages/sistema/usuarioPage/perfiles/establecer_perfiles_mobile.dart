...
class EstablecerPerfilesMobile extends StatefulWidget {
  const EstablecerPerfilesMobile({super.key});

  @override
  State<EstablecerPerfilesMobile> createState() => _EstablecerPerfilesMobileState();
}

class _EstablecerPerfilesMobileState extends State<EstablecerPerfilesMobile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarMobile(titulo: 'Perfiles de: ${user.nombre}'),
