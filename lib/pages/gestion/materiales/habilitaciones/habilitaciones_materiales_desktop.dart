...
class HabilitacionesMaterialDesktop extends StatefulWidget {
  const HabilitacionesMaterialDesktop({super.key});

  @override
  State<HabilitacionesMaterialDesktop> createState() => _HabilitacionesMaterialDesktopState();
}

class _HabilitacionesMaterialDesktopState extends State<HabilitacionesMaterialDesktop> {
