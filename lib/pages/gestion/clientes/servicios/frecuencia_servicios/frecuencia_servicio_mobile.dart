...
class FrecuenciaServicioMobile extends StatefulWidget {
  ...
  const FrecuenciaServicioMobile({super.key, required this.cliente, required this.token, required this.servicioCliente});
...
class _FrecuenciaServicioMobileState extends State<FrecuenciaServicioMobile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarMobile(titulo: 'Frecuencia del servicio ${widget.servicioCliente.descripcion}'),
