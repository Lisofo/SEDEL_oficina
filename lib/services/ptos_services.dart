...
class PtosInspeccionServices {
  ...
  Future postAcciones(BuildContext context, Orden orden, List<RevisionPtoInspeccion> acciones, int revisionId, String token) async {
    String link = '${apiUrl}api/v1/ordenes/${orden.ordenTrabajoId}/revisiones/$revisionId/puntos/acciones';
    print(link);
    List datos = [];
    var mapa;
  ...
  Future deleteAcciones(BuildContext context, Orden orden, List<RevisionPtoInspeccion> acciones, int revisionId, String token) async {
    String link = '${apiUrl}api/v1/ordenes/${orden.ordenTrabajoId}/revisiones/$revisionId/puntos/acciones';
    print(link);
    List datos = [];
    var mapa;
